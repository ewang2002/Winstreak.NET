...
using Winstreak.Core.WebApi.Mojang.Definitions;
using static Winstreak.Core.WebApi.CachedData;

namespace Winstreak.Core.WebApi.Mojang
{
	public static class MojangApi
	{
		...
		/// </summary>
		public static readonly int MaximumRequestsInRateLimit = 600;

		/// <summary>
		/// The amount of time before the rate limit is reset. 
		/// </summary>
		public static readonly TimeSpan MojangRateLimit = TimeSpan.FromMinutes(10);
